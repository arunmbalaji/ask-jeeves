...
export default class ApolloClient<TCacheShape> implements DataProxy {
     ...
     * use `readFragment`.
     */
    readQuery<T, TVariables = OperationVariables>(options: DataProxy.Query<TVariables>): T | null;
    /**
     * Tries to read some data from the store in the shape of the provided
     ...
     * `fragmentName`.
     */
    readFragment<T, TVariables = OperationVariables>(options: DataProxy.Fragment<TVariables>): T | null;
    /**
