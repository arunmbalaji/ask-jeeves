...
let regexFileAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (filename, regex, replace) {
...
let prepareDetachedServiceContextIosAsync = (() => {
  var _ref9 = _asyncToGenerator(function* (projectDir, args) {
    ...
    const context = (_StandaloneContext || _load_StandaloneContext()).default.createServiceContext(_path.default.join(projectDir, '..', '..'), null, null, null,
