...
let validateCredentialsForPlatform = exports.validateCredentialsForPlatform = (() => {
  var _ref6 = _asyncToGenerator(function* (platform, validationType, credentials, metadata) {
    const { requestId, isValid, error, errorCode, errorMessage } = yield (_Api || _load_Api()).default.callMethodAsync('validateCredentials', [], 'post', _extends({
      credentials,
      platform,
      validationType
    }, metadata));
...
let fetchAppleCertificates = exports.fetchAppleCertificates = (() => {
  var _ref7 = _asyncToGenerator(function* (metadata) {
    const { requestId, err, success, error, errorCode, errorMessage } = yield (_Api || _load_Api()).default.callMethodAsync('fetchAppleCertificates', [], 'post', _extends({}, metadata));
...
let ensureAppId = exports.ensureAppId = (() => {
  var _ref8 = _asyncToGenerator(function* (metadata) {
    const { requestId, err, success, errorCode, errorMessage } = yield (_Api || _load_Api()).default.callMethodAsync('ensureAppId', [], 'post', _extends({}, metadata));
